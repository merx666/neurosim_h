...
// Optimization: Group substances once at module load instead of every render
// This prevents an O(N) recalculation when the component re-renders (e.g. on language change)

...
// ⚡ Bolt Optimization: Grouped substances calculation is a heavy O(N) operation
// over a large static object. Moving it outside the component prevents it
// from being recalculated on every render.

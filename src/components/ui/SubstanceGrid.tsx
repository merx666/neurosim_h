...
// ⚡ Bolt Optimization: Calculate derived state from static data once outside the component
// Prevents expensive O(N) recalculations of grouped substances on every render/mount

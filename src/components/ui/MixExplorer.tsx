...
export function MixExplorer() {
  ...
  // ⚡ Bolt Optimization: Memoize derived search arrays to avoid recalculation on every render.
  // Hoisted .toLowerCase() out of the inner .filter() loop to reduce redundant string allocation.

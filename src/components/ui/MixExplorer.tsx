...
export function MixExplorer() {
  ...
  // ⚡ Bolt: Memoize filtered list to prevent O(N) filtering on every render
  // Also hoisted .toLowerCase() on the query outside the filter loop to avoid redundant string allocations

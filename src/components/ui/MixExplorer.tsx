...
export function MixExplorer() {
  ...
  // ⚡ Bolt: Memoize filtered lists and hoist string transformations outside the loop
  // This avoids redundant .toLowerCase() calls and prevents O(N) recalculations on every render
